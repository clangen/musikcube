...
!define PROJECT_NAME "musikServer 2"
!define SUB_NAME "developers milestone 3.3.2"
!define INSTALLER_NAME "mC2ServerDm3.3.2"
!define INSTALL_DIR "musikServer 2"
...
Section "!mC2" main
	...
	CreateShortCut "$SMPROGRAMS\${PROJECT_NAME} ${SUB_NAME}\${PROJECT_NAME}.lnk" "$INSTDIR\musikServer.exe"
